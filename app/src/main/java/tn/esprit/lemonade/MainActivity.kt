...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage!!.setOnClickListener {
            // méthode qui gère l'état lorsque l'image est cliquée
            clickLemonImage()
        }
    ...
    private fun clickLemonImage() {
        // utilisez une instruction conditionnelle comme 'if' ou 'when'  pour suivre le limonadeState
        ...
        // Lorsque l'on clique sur l'image dans l'état SELECT, l'état doit devenir SQUEEZE
        ...
        // Lorsque l'on clique sur l'image dans l'état SQUEEZE, le squeezeCount doit être
        ...
        // Lorsque l'on clique sur l'image dans l'état DRINK, l'état doit devenir RESTART

        // Lorsque l'on clique sur l'image dans l'état RESTART, l'état doit devenir SELECT

        // Enfin, avant que la fonction ne se termine, nous devons définir les éléments de vue de sorte que
    ...
    private fun setViewElements() {
        ...
        // mettre en place une condition qui suit la limonadeState

        // pour chaque état, le textAction TextView doit être défini sur la chaîne correspondante
        //  du fichier de string ressources . Les strings sont nommées pour correspondre à l'état

        // De plus, pour chaque état, le lemonImage doit être défini sur le correspondant
